...
const Stores = () => {
    ...
    const handleDelete = () => {
        apiClient.deleteStore(jwt, selectedStore._id).then(() =>
    ...
    return (
        <Container>
            <Row>
                <h1>Inventario</h1>
                <Col>
                    <Button onClick={handleShowNewStoreModal}>Sumar nuevo producto</Button>
                    <hr />
                            ...
                            stores.map((store) => {
                                return (
                                    <tr>
                                        <td>{store._id}</td>
                                        <td>{store.name}</td>
                                        <td><AiOutlineDelete onClick={() => handleDeleteConfirmation(store)}/></td>
                                    </tr>
                                );
                            })}
                        </tbody>
